...
import com.devsatish.produck.model.AppDatabase
...
import com.devsatish.produck.view.MainScreen
import com.devsatish.produck.viewmodel.TimerViewModel
import com.devsatish.produck.viewmodel.TimerViewModelFactory
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val repository = TimerRepository(database.taskDao())
